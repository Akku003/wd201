...
describe("Todo Application", function () {
  ...
  const deleteNonExistentResponse = await agent.delete(`/todos/${todoID}`).send();
  expect(deleteNonExistentResponse.statusCode).toBe(200);
  expect(deleteNonExistentResponse.text).toBe("false");
});
});
